...
1. `CLAUDE.md`
2. `docs/README.md`
3. `docs/quality-foundation/README.md`
4. `docs/quality-foundation/web-release-readiness.md`
5. `docs/quality-foundation/task-list.md`（状態の正本＝進捗ボード。
   進行中・未着手・保留P0/P1の詳細は `docs/quality-foundation/tasks/<ID>.md`、
   完了分とP2/P3保留分は同directoryの集約file）
6. `docs/quality-foundation/working-agreement.md`
7. `docs/quality-foundation/decisions.md`
8. `docs/quality-foundation/session-log.md`

Google Playへ着手する場合だけ、`docs/quality-foundation/google-play-readiness.md` と
`docs/quality-foundation/quality-scorecard.md` も読みます。2026-07-27のsprint計画と
`docs/quality-foundation/project-status.md`は履歴snapshotです。
...
- Web release判定は `docs/quality-foundation/web-release-readiness.md` を正とする。
  Google Play release判定では `quality-scorecard.md` を双方が独立採点し、低い方の点数を採用する。
